...
const getActiveClassesBySchool = async (req, res) => {
    try {
        ...
        const [activeCount, inactiveCount] = await Promise.all([
            ClassesModel.countDocuments({ schoolId: schoolObjectId: schoolObjectId, status: "ACTIVE" }),
            ClassesModel.countDocuments({ schoolId: schoolObjectId: schoolObjectId, status: "INACTIVE" }),
        ]);
        ...
        const classes = await ClassesModel.find({
            schoolId: schoolObjectId: schoolObjectId,
            status: filterStatus,
        })
